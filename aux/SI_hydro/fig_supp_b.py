...
cmd.show("spheres", "id 262 or id 263 or id 4342")
...
cgo_arrow("id 262", "id 263", radius = .08, gap = .1, hradius = .25, color = "blue", name = "arrow_CE1_ND1")
...
cmd.origin("id 263")
#
cmd.png("bSI_hydro.png", width=500, height=400, dpi=600, ray=1)
