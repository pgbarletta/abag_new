###
# Script to get the shielding polar atoms for each PDB. It does pretty much the
# same thing interactions_hydrophobic does, but discarding the carbons and just
# keeping the shielding polar atoms.
###
import sys
